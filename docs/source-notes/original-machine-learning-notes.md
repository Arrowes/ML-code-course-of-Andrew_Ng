...
![代价函数与等高线图（原稿 p.7）](./assets/page-007.jpg)
...
![一对多分类示意（原稿 p.21）](./assets/page-021.jpg)
...
![神经元组合逻辑门（原稿 p.29）](./assets/page-029.jpg)
...
![偏差与方差诊断（原稿 p.43）](./assets/page-043.jpg)
...
![Precision、Recall 与阈值（原稿 p.50）](./assets/page-050.jpg)
...
![核函数与非线性边界（原稿 p.58）](./assets/page-058.jpg)
...
![PCA、协方差与特征向量（原稿 p.69）](./assets/page-069.jpg)
...
![低秩矩阵分解示意（原稿 p.81）](./assets/page-081.jpg)
...
![图片文字识别流水线（原稿 p.87）](./assets/page-087.jpg)
